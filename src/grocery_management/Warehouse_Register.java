 ...
 * @author Roshan
 */
public class Warehouse_Register extends javax.swing.JFrame {
    String link = "jdbc:mysql://localhost:3306/grocery";
    String username = "";
    String pass = "";

    @SuppressWarnings("OverridableMethodCallInConstructor")
    public Warehouse_Register() {
        initComponents();
        Fetch();
    }
    ...
    private void initComponents() {
        ...
        UPDATE_DELETE_BTN = new javax.swing.JButton();
        ...
        ADD_RECORD.setBackground(new java.awt.Color(0, 153, 0));
        ...
        UPDATE_DELETE_BTN.setBackground(new java.awt.Color(204, 0, 0));
        UPDATE_DELETE_BTN.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        UPDATE_DELETE_BTN.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grocery_management/setting.png"))); // NOI18N
        UPDATE_DELETE_BTN.setText("UPDATE/DELETE RECORD");
        UPDATE_DELETE_BTN.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                UPDATE_DELETE_BTNActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
                jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGap(24, 24, 24)
                                .addComponent(ADD_RECORD, javax.swing.GroupLayout.PREFERRED_SIZE, 190,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(46, 46, 46)
                                .addComponent(UPDATE_DELETE_BTN)
                                .addGap(57, 57, 57)
    ...
    private void ADD_RECORDActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ADD_RECORDActionPerformed
        try {
            ...
            PreparedStatement pst = con.prepareStatement(
                    "insert into Warehouse(ID,WR_NAME,OWNER,ADDRESS,TELEPHONE,MOBILE1,MOBILE2,EMAIL,AADHAR) values(?,?,?,?,?,?,?,?,?)");
            pst.setString(1, ID.getText());
            pst.setString(2, WR_NAME.getText());
            pst.setString(3, OWNER.getText());
            pst.setString(4, ADDRESS.getText());
            pst.setString(5, TELEPHONE.getText());
            pst.setString(6, MOBILE1.getText());
            pst.setString(7, MOBILE2.getText());
            pst.setString(8, EMAIL.getText());
            pst.setString(9, AADHAR.getText());
            pst.executeUpdate();
    ...
    private void UPDATE_DELETE_BTNActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_UPDATE_DELETE_BTNActionPerformed
        EDIT_WAREHOUSE edit = new EDIT_WAREHOUSE();
        edit.setVisible(true);
        dispose();
    }// GEN-LAST:event_UPDATE_DELETE_BTNActionPerformed
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(Warehouse_Register.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        }
        java.awt.EventQueue.invokeLater(() -> {
            new Warehouse_Register().setVisible(true);
        });
    }
    ...
    private javax.swing.JButton UPDATE_DELETE_BTN;
